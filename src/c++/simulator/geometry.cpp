...
double Geometry::get_volume() const { return 0.0; }

double Geometry::get_surface() const { return 0.0; }

double Geometry::get_radius() const { return 0.0; }

double PrimitiveGeometry::get_volume() const { return 0.0; }

double PrimitiveGeometry::get_surface() const { return 0.0; }

double PrimitiveGeometry::get_radius() const { return 0.0; }

InfinityPlane::InfinityPlane(double x, double y, double z, double nx, double ny,
                             double nz)
...
double InfinityPlane::get_volume() const { return 0.0; }

double InfinityPlane::get_surface() const { return 0.0; }

Sphere::Sphere(double x, double y, double z, double radius)
    : center(Point{x, y, z}), radius(radius) {}

Sphere::Sphere(double radius) : center(Point{0.0, 0.0, 0.0}), radius(radius) {}

double Sphere::get_volume() const { return get_surface() * radius / 3.0; }

double Sphere::get_surface() const { return 4.0 * M_PI * radius * radius; }
...
Vector Edge::get_vector() const { return points.at(1) - points.at(0); }
...
double Edge::get_volume() const { return 0.0; }

double Edge::get_surface() const { return 0.0; }
...
double PlanarGeometry::get_volume() const { return 0.0; }
...
double Square::get_surface() const { return 0.0; }
